...
?>
  <p class="lead text-center text-muted" style="font-weight: bold; font-size: 3.2em;"><FONT COLOR="#1A1110">List of All Books</FONT></p>
...
<style>
  /* Background image */
  body {
    background-image: url('./bootstrap/img/boooks.jpg'); /* Use a relative path */
