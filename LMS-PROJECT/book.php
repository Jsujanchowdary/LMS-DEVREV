...
<div class="row">
  <div class="col-md-3 text-center book-item">
    <div class="img-holder overflow-hidden">
      <img class="img-top animated fadeIn" src="./bootstrap/img/<?php echo $row['book_image']; ?>">
    </div>
  </div>
  <div class="col-md-9">
    <div class="card rounded-0 shadow">
      <div class="card-body">
        <div class="container-fluid">
          ...
          <hr>
          <p class="animated slideInRight"><?php echo $row['book_descr']; ?></p>
          <h4 class="animated slideInLeft">Details</h4>
          ...
          <form method="post" action="cart.php" class="animated fadeIn">
