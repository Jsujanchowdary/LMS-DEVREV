	...
	*/
	...
	if(isset($book_isbn)){
		...
		if(!isset($_SESSION['cart'])){
			// $_SESSION['cart'] is an associative array that bookisbn => qty
			$_SESSION['cart'] = array();
...
<head>
	...
	<!-- Add your custom CSS for animations and styles here -->
</head>
<body>
	<div class="container">
...
<style>
	body {
		background-image: url('./bootstrap/img/cart.jpg'); /* Use a relative path */
		background-size: cover;
		background-repeat: no-repeat;
		background-attachment: fixed; /* Keeps the background fixed while scrolling */
	}

	/* Add your custom CSS animations and styles here */
</style>
